...
export const DeleteUserConfirmModal = ({ user, open, onOpenChange, onSuccess }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.log('User deletion/deactivation result:', result);
      
      if (result.softDelete) {
        showToast({
          title: 'Success',
          message: 'User has been deactivated successfully (soft delete)',
          type: 'success'
        });
      } else {
        showToast({
